    ...
    <div class="wrapper d-flex">
        ...
        <div class="content">
            <div class="main-header">
                <div>
                    <h2 class="fw-bold m-0 text-slate-800">Patient Registry</h2>
                    <p class="text-muted m-0">Register and manage profiles for hospital check-ins</p>
                </div>
                <div>
                    <button class="btn btn-emerald rounded-pill px-4 btn-success" data-bs-toggle="modal" data-bs-target="#addPatientModal">
            ...
            <div class="modal-content border-0 rounded-4">
                <form action="patient-management" method="POST">
                    ...
                    <div class="modal-footer border-top-0 pb-4">
                        ...
                        <button type="submit" class="btn btn-success rounded-pill px-4">Register Patient</button>
                    </div>
                </form>
            </div>
        </div>
