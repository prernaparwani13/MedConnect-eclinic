...
<%
    ...
    List<MedicalRecord> records = recordDAO.getMedicalRecordsByPatientId(userId);
%>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>My Diagnostic Reports - MedConnect</title>
    ...
    <div class="wrapper d-flex">
        ...
        <div class="content">
            <div class="main-header">
                <div>
                    <h2 class="fw-bold m-0 text-slate-800">My Diagnostic & Laboratory Reports</h2>
                    <p class="text-muted m-0">View or download report documents uploaded by medical staff</p>
                </div>
            </div>
                ...
                <div class="table-responsive">
                    <table class="table table-hover align-middle">
                        ...
                        <tbody>
                            ...
                            %>
                                <tr>
                                    <td colspan="5" class="text-center py-4 text-muted">No diagnostic reports uploaded for you.</td>
                                </tr>
                            <%
                                } else {
                            ...
                            %>
                                <tr>
                                    <td class="fw-semibold">Dr. <%= r.getDoctorName() %></td>
