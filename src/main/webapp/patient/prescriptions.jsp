...
<%
    ...
    List<Prescription> prescriptions = prescriptionDAO.getPrescriptionsByPatientId(userId);
%>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <div class="wrapper d-flex">
        ...
        <div class="content">
            <div class="main-header">
                <div>
                    <h2 class="fw-bold m-0 text-slate-800">My Written Prescriptions</h2>
                    <p class="text-muted m-0">View all clinical prescriptions and dosage details recommended by doctors</p>
                </div>
            </div>
                ...
                <div class="table-responsive">
                    <table class="table table-hover align-middle">
                        ...
                        <tbody>
                            ...
                            %>
                                <tr>
                                    <td colspan="6" class="text-center py-4 text-muted">No prescriptions issued for you.</td>
                                </tr>
                            <%
                                } else {
                            ...
                            %>
                                <tr>
                                    <td class="fw-semibold">Dr. <%= p.getDoctorName() %></td>
